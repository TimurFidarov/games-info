                    ...
                    <div class="flex items-center space-x-4 mt-4 sm:ml-12 md:mt-0">
                        @if(isset($game['social']['website']))
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center hover:opacity-75">
                                <a href="{{$game['social']['website']['url']}}" target="_blank"><svg class="w-5 h-5 fill-current"
                                                                               viewBox="0 0 16 17" fill="none"><path
                ...
                @foreach($game['similarGames'] as $game)
                    ...
                    <div class="relative inline-block">
                        <a href="/games/{{ $game['slug'] }}">
                            <img  src="{{ $game['coverImageUrl'] }}" alt="game
                            cover"
