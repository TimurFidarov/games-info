...
@section('content')
    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex">
            <div class="flex-none">
                <img src="/game-poster.jpg" alt="cover">
            </div>
        ...
        <div class="screenshots-container pb-12 mt-8 border-b border-gray-800">
            ...
            <div class="grid grid-cols-3 gap-12 mt-8">
                <div>
                    <a href="#">
                        <img src="/scr-1.png" alt="screenshot" class="hover:opacity-75 transition ease-in-out
                        duration-150">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="/scr-2.png" alt="screenshot" class="hover:opacity-75 transition ease-in-out
                        duration-150">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="/scr-3.png" alt="screenshot" class="hover:opacity-75 transition ease-in-out
                        duration-150">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="/scr-4.png" alt="screenshot" class="hover:opacity-75 transition ease-in-out
                        duration-150">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="/scr-5.png" alt="screenshot" class="hover:opacity-75 transition ease-in-out
                        duration-150">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="/scr-6.png" alt="screenshot" class="hover:opacity-75 transition ease-in-out
                        duration 150">
                    </a>
                </div>
            </div>
            ...
            <div class="similar-games text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-12">
                <div class="game mt-8">
                    <div class="relative inline-block">
                        <a href="#">
                            <img  src="/game-poster.jpg" alt="game cover" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
