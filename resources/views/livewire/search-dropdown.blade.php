<div class="relative">
    <input wire:model.debounce.300ms="search" type="text" class="bg-gray-800 text-sm rounded-full px-3 py-1 pl-8 w-64
    focus:outline-none
    focus:ring" placeholder="Search...">
    ...
    @if(strlen($search) >=2)
    <div class="absolute z-10 bg-gray-800 text-xs rounded w-64 mt-2">
